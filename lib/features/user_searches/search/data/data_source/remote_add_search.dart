...
class RemoteAddSearch with HandlingExceptionRequest {
  Future<Either<Failure, AddSearchModel>> postSearchs(
      Map<String, dynamic> param) async {
    final postApi = PostApi<AddSearchModel>(
        param: param,
        fromJson: addSearchModelFromJson,
        url: "postsearch",
    ...
    Either<Failure, AddSearchModel> result = await postApi
        .handlingExceptionRequest<AddSearchModel>(requestCall: callRequest);
    return result;
  }
}
