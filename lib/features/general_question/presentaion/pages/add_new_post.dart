...
class AddNewGlobalPost extends StatefulWidget {
  @override
  _AddNewGlobalPost createState() => _AddNewGlobalPost();
}

class _AddNewGlobalPost extends State<AddNewGlobalPost> {
                    ...
                    AppButton(
                        function: () async {
                          ...
                          postBloc.add(AddNewPost(
                            description: values,
                            subjectID: _keyEditor.currentState.getTapsId(),
